...
img: assets/img/research/saxs_overview.png
importance: 2
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/research/saxs_overview.png" title="AI-SAXS framework" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
